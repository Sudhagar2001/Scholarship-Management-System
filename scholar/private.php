...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errorMessages)) {
        ...
        $sql = "INSERT INTO scholarship_private (student_name, date_of_birth, gender, reg_no, course, department, college, community, college_name, account_number, ifsc_code, bank_name, branch, aadhar, community_doc, marksheet, income_certificate)
