...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errorMessages)) {
        ...
        $sql = "INSERT INTO scholarship_state (student_name, date_of_birth, gender, reg_no, course, department, college, community, college_name, account_number, ifsc_code, bank_name, branch, aadhar, community_doc, marksheet, income_certificate)
...
<head>
    ...
    <title>State Scholarship Form</title>
    <style>
        body {
...
<body>
    <form action="admin_state_form.php" method="post" enctype="multipart/form-data">
        <h2>Private Scholarship Form</h2>
